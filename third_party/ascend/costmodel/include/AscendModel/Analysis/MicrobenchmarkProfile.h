...
#ifndef ASCENDMODEL_ANALYSIS_MICROBENCHMARKPROFILE_H
#define ASCENDMODEL_ANALYSIS_MICROBENCHMARKPROFILE_H
...
public:
  ...
  getMeasurement(llvm::StringRef key) const;

  llvm::Expected<double>
  requireValue(llvm::StringRef key,
               std::optional<llvm::StringRef> expectedUnit = std::nullopt,
               std::optional<llvm::StringRef> expectedCycleDomain =
                   std::nullopt) const;
...
#endif // ASCENDMODEL_ANALYSIS_MICROBENCHMARKPROFILE_H
